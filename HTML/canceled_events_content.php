    ...
    <div class="event-card">
        ...
        <div class="event-details">
            ...
            <div class="event-meta">
                ...
                <?php endif; ?>
                <div class="event-meta-item">
                    <strong>Canceled On:</strong> <?php echo date('F j, Y', strtotime($event['canceled_at'])); ?>
                </div>
            </div>
        ...
        <div class="event-actions">
            <a href="event_details.php?id=<?php echo $event['event_id']; ?>" class="action-btn view-btn">View Event Details</a>
            <button class="action-btn rejoin-btn" onclick="rejoinEvent(<?php echo $event['event_id']; ?>)">Rejoin Event</button>
        </div>
    </div>
    <?php endforeach; ?>
<?php endif; ?>